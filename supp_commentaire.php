...
if (isset($_SESSION['id']) && isset($_SESSION['type']))
  {
    if ($_SESSION['type'] == 'famille')
      {
        $site = new page_base_securisee_famille('Supprimer Commentaire');
            ...
            foreach ($_POST["nom_checkbox"] as $index => $value)
              {
                ...
                $site->left_sidebar   = $controleur->retourne_supp_commentaire('SuppCommentaire', $value);
    ...
    else
      {
        if ($_SESSION['type'] == 'admin')
          {
            $site = new page_base_securisee_admin('Supprimer Commentaire');

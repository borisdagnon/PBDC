...
if (isset($_SESSION['id']) && isset($_SESSION['type'])) {
    ...
    if ($_SESSION['type'] == 'admin') {
        ...
        $site        = new page_base_securisee_admin('liste famille');
        ...
        $site->left_sidebar  = $controleur->affiche_liste_famille('liste');
        if (isset($_POST["nom_checkbox"])) {
            foreach ($_POST["nom_checkbox"] as $index => $value) {
                $_SESSION['id_eleve'] = $value;
                $site->left_sidebar   = $controleur->affiche_liste_enfant_famille_admin('liste');
                break;
            }
        }
